...
def load_weights():
    # Set weights path
    dirPath = 'F:\CSE\Machine Learning\Deep Learning Assignment\Face_Recognition\weights'
...
def save_image(image_name):
    fname = "F:\CSE\Machine Learning\Deep Learning Assignment\Face_Recognition\images" + image_name
    image = np.array(ndimage.imread(fname, flatten=False))
    my_image = scipy.misc.imresize(image, size=(96,96)).reshape((96,96,3))
    return my_image
